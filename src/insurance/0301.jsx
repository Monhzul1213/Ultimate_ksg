...
class BHistory27 extends React.Component {
    constructor(props) {
        super(props);
              ...
              >
                {getFieldDecorator("PremiumAmt")(
                  <Input/>
                                                                           ...
                                                                           <Form.Item
                label="Жолооны үнэмлэх авсан огноо"
                style={{ marginBottom: "0px" }}
                {...formLayount}
              >
                {getFieldDecorator("PremiumAmt")(
              ...
              >
                {getFieldDecorator("PremiumAmt")(
                  <Input/>
                                             ...
                                             <Form.Item
                label="Нэмэлт тоноглол байгаа эсэх"
                style={{ marginBottom: "0px" }}
                {...formLayount}
              >
                {getFieldDecorator("PremiumAmt")(
...
const EditableFormTable = Form.create()(BHistory27);
