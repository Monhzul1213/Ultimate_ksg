  ...
  constructor(props) {
    ...
    this.columns = [
      ...
      },
      {
        ...
        dataIndex: "dmgLostPercent",
      },
      {
        title: "Хөдөлмөрийн чадвар түр алдсан хоног",
        dataIndex: "dmgLostDuration",
      },
      {
        title: "Онош/Монгол/",
  ...
  showModal = (data) => {
    ...
    if (data) {
      form.setFieldsValue({
        ...
        dmgLostPercent: data.dmgLostPercent,
        dmgLostDuration: data.dmgLostDuration,
        dmgDiagnose: data.dmgDiagnose,
        dmgDiagnoseCipher: data.dmgDiagnoseCipher,
        dmgDescr: data.dmgDescr,
            ...
            <Row gutter={16} type="flex">
              ...
              <Col {...columnConfig}>
                <Form.Item {...formItemLayout}>
                  ...
                  >
                    Хөдөлмөрийн чадвар түр алдсан хувь
                  </p>
                  {getFieldDecorator("dmgLostPercent")(
                    <Input
                      style={{
                        marginBottom: "8px",
                        fontSize: "10pt",
            ...
            <Row gutter={16} type="flex">
              <Col {...columnConfig}>
                <Form.Item {...formItemLayout}>
                  ...
                  >
                    Хөдөлмөрийн чадвар түр алдсан хоног
                  </p>
                  {getFieldDecorator("dmgLostDuration")(
                    <Input
                      style={{
                        marginBottom: "8px",
                        fontSize: "10pt",
                    ...
                    >
                      {baseData &&
                        baseData.Table5.map((item) => (
                          <Option key={item.IndEvaluteID}>
                            {item.IndEvaluteID}-{item.IndEvaluteDescr}
                          </Option>
                        ))}
                    </Select>
                  )}
...
const EditableFormTable = Form.create()(Table2);
