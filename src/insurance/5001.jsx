...
class BHistory75 extends React.Component {
    constructor(props) {
        super(props);
              ...
              >
                {getFieldDecorator("PremiumAmt")(
                  <Input/>
                      ...
                      <Form.Item
                label="1 удаагийн хариуцлагын хязгаар"
                style={{ marginBottom: "0px" }}
                {...formLayount}
              >
                {getFieldDecorator("PremiumAmt")(
              ...
              >
                {getFieldDecorator("PremiumAmt")(
                  <Input/>
                                     ...
                                     <Form.Item
                label="Галын дохиолол, хамгаалалт"
                style={{ marginBottom: "0px" }}
                {...formLayount}
              >
                {getFieldDecorator("PremiumAmt")(
              ...
              >
                {getFieldDecorator("PremiumAmt")(
                  <Input/>
                                                 ...
                                                 <Form.Item
                label="Цахилгааны монтаж ил эсэх"
                style={{ marginBottom: "0px" }}
                {...formLayount}
              >
                {getFieldDecorator("PremiumAmt")(
...
const EditableFormTable = Form.create()(BHistory75);
