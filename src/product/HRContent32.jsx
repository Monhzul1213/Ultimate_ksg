...
import HRContent321 from "./HRContent321";
      ...
      />
        ...
        <Row>
          ...
          <h4 align="right" style={{ fontSize: "10pt", marginBottom: "0px " }} >
             <b>{this.state.baseData && this.state.baseData.Table2 && `${currencyFormat(this.state.baseData.Table2[0].Amount )}`} </b> 
          </h4>
          </Col>
        </Row>
      </div>
  ...
  <Card className="card-padding" style={{ borderRadius: "8px" }}>
      ...
      />
        ...
        <Row>
          ...
          <Col span={12}>
          <h4 align="right" style={{ fontSize: "10pt", marginBottom: "0px " }} >
            <b> {this.state.baseData && this.state.baseData.Table3 && this.state.baseData.Table3[0].UserCount}</b>
            </h4>
          </Col>
        </Row>
      </div>
