...
import HRContent331 from "./HRContent331";
      ...
      />
        ...
        <Row>
          ...
          <h4 align="right" style={{ fontSize: "10pt", marginBottom: "0px " }} >
             <b>{this.state.baseData && this.state.baseData.Table && `${currencyFormat(this.state.baseData.Table[0].paidAmt )}`} </b> 
          </h4>
          </Col>
        </Row>
      </div>
  ...
  <Card className="card-padding" style={{ borderRadius: "8px" }}>
      ...
      />
        ...
        <Row>
          ...
          <Col span={12}>
          <h4 align="right" style={{ fontSize: "10pt", marginBottom: "0px " }} >
            <b> {this.state.baseData && this.state.baseData.Table1 && this.state.baseData.Table1[0].UserCount}</b>
            </h4>
          </Col>
        </Row>
      </div>
