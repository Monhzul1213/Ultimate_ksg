...
class HrContent9 extends React.Component  {
  state = {
    showReport: false
  };
  ...
  render(){
    ...
    const columns = [
      ...
      { title: "Төлөв", dataIndex: "StatusName", width: 150, render: text => <Tag color={"#faad14"} style={{width: 80, textAlign: "center"}}>{text}</Tag> },
